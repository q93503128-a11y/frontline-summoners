...
test('server co-op scaling preserves dedicated SPECIAL boss mechanics', () => {
  const battle = createServerCoopBattle('special_glutton_04', militiaLoadout(), militiaLoadout());
  ...
  const anomaly = createServerCoopBattle('special_anomaly_04', militiaLoadout(), militiaLoadout());

CREATE TABLE account_mutation_receipts_v3 (
  user_id TEXT NOT NULL REFERENCES users(id) ON DELETE CASCADE,
  mutation_kind TEXT NOT NULL CHECK (mutation_kind IN ('MAIN_BATTLE_RESULT', 'SPECIAL_BATTLE_RESULT', 'RECORD_RESULT', 'RECRUITMENT', 'SWEEP', 'META_PROGRESSION')),
...
INSERT INTO account_mutation_receipts_v3
...
ALTER TABLE account_mutation_receipts_v3 RENAME TO account_mutation_receipts;

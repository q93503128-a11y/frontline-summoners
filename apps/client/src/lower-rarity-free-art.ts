...
export const LOWER_RARITY_FREE_ART_FAMILIES: readonly LowerRarityFreeArtFamily[] = [
  ...
  normalizedPixelFamily('cc0-glass-keeper-f1', 158),
  normalizedPixelFamily('cc0-glass-keeper-f2', 174),
  normalizedPixelFamily('cc0-glass-keeper-f3', 190),
  normalizedPixelFamily('cc0-bonedrum-f1', 156),
  normalizedPixelFamily('cc0-bonedrum-f2', 172),
  normalizedPixelFamily('cc0-bonedrum-f3', 188),
  normalizedPixelFamily('cc0-paper-dragon-f1', 154),
  normalizedPixelFamily('cc0-paper-dragon-f2', 170),
  normalizedPixelFamily('cc0-paper-dragon-f3', 188),
  normalizedPixelFamily('cc0-meteor-cart-f1', 164),
  normalizedPixelFamily('cc0-meteor-cart-f2', 182),
  normalizedPixelFamily('cc0-meteor-cart-f3', 200),
  normalizedPixelFamily('cc0-mirror-guide-f1', 156),
  normalizedPixelFamily('cc0-mirror-guide-f2', 172),
  normalizedPixelFamily('cc0-mirror-guide-f3', 190),
] as const;
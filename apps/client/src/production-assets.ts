...
const PLACEHOLDER_PLAYER_FORM_ART: Readonly<Record<string, UnitArtVariant>> = {
  ...
  char_common_c_turnip_rider_f3: { familyId: 'cc0-turnip-rider-f3', tint: 0xffffff, displayScale: 1.08, attackFx: 'SLASH' },
  ...
  char_common_c_slinger_f1: { familyId: 'cc0-slinger-f1', tint: 0xffffff, displayScale: 0.94, attackFx: 'PIERCE' },
  char_common_c_slinger_f2: { familyId: 'cc0-slinger-f2', tint: 0xffffff, displayScale: 1.00, attackFx: 'PIERCE' },
  char_common_c_slinger_f3: { familyId: 'cc0-slinger-f3', tint: 0xffffff, displayScale: 1.07, attackFx: 'PIERCE' },
  ...
  char_common_b_coffin_merchant_f3: { familyId: 'cc0-coffin-merchant-f3', tint: 0xffffff, displayScale: 1.08, attackFx: 'VOID' },
  char_common_b_moss_golem_f1: { familyId: 'cc0-moss-golem-f1', tint: 0xffffff, displayScale: 0.96, attackFx: 'MAGIC' },
  char_common_b_moss_golem_f2: { familyId: 'cc0-moss-golem-f2', tint: 0xffffff, displayScale: 1.02, attackFx: 'MAGIC' },
  char_common_b_moss_golem_f3: { familyId: 'cc0-moss-golem-f3', tint: 0xffffff, displayScale: 1.10, attackFx: 'MAGIC' },
  char_common_b_ink_raven_f1: { familyId: 'cc0-ink-raven-f1', tint: 0xffffff, displayScale: 0.96, attackFx: 'VOID' },
  char_common_b_ink_raven_f2: { familyId: 'cc0-ink-raven-f2', tint: 0xffffff, displayScale: 1.02, attackFx: 'VOID' },
  char_common_b_ink_raven_f3: { familyId: 'cc0-ink-raven-f3', tint: 0xffffff, displayScale: 1.08, attackFx: 'VOID' },

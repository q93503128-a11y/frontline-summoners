...
export class MainMenuScene extends Phaser.Scene {
  ...
  create(): void {
    ...
    if (isFirstSliceProductionReviewMode() || isSecondSliceProductionReviewMode() || isThirdSliceProductionReviewMode() || isFourthSliceProductionReviewMode() || isFifthSliceProductionReviewMode() || isSixthSliceProductionReviewMode()) {
      const reviewLabel = isSixthSliceProductionReviewMode()

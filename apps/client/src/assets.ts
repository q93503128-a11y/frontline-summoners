...
export const ART_FAMILIES: readonly ArtFamily[] = [
  {
    id: 'hero-knight', displayHeight: 236, attackContactFrame: 4,
  ...
  {
    id: 'hero-knight-2', displayHeight: 230, attackContactFrame: 3,
  ...
  {
    id: 'fantasy-warrior', displayHeight: 234, attackContactFrame: 4,
  ...
  {
    id: 'wizard', displayHeight: 244, attackContactFrame: 3,
  ...
  {
    id: 'warrior', displayHeight: 226, attackContactFrame: 2,
  ...
  {
    id: 'warrior-3', displayHeight: 228, attackContactFrame: 2,
  ...
  {
    id: 'huntress', displayHeight: 232, attackContactFrame: 3,
  ...
  {
    id: 'evil-wizard', displayHeight: 236, attackContactFrame: 5,
...
export const UNIT_ART: Readonly<Record<string, UnitArtVariant>> = {
  militia: { familyId: 'warrior-3', tint: 0xffffff, displayScale: 1.08, attackFx: 'SLASH' },
  guard: { familyId: 'hero-knight-2', tint: 0xffffff, displayScale: 1.08, attackFx: 'BLUNT' },
  hunter: { familyId: 'huntress', tint: 0xffffff, displayScale: 1.08, attackFx: 'PIERCE' },
  duelist: { familyId: 'fantasy-warrior', tint: 0xffffff, displayScale: 1.08, attackFx: 'SLASH' },
  lancer: { familyId: 'warrior-1', tint: 0xffffff, displayScale: 1.30, attackFx: 'PIERCE' },
  battlemage: { familyId: 'wizard', tint: 0xffffff, displayScale: 1.06, attackFx: 'MAGIC' },
  pyromancer: { familyId: 'evil-wizard', tint: 0xffffff, displayScale: 1.10, attackFx: 'FIRE' },
  royal: { familyId: 'hero-knight', tint: 0xffffff, displayScale: 1.12, attackFx: 'SLASH' },
  heretic: { familyId: 'evil-wizard-2', tint: 0xffffff, displayScale: 1.30, attackFx: 'VOID' },
  voidsage: { familyId: 'martial-hero-2', tint: 0xffffff, displayScale: 1.32, attackFx: 'VOID' },
  ...
  'enemy-raider': { familyId: 'cc0-tin-squire-f1', tint: 0xffffff, displayScale: 1.42, attackFx: 'SLASH' },
  'enemy-sprinter': { familyId: 'cc0-clockduck-f1', tint: 0xffffff, displayScale: 1.38, attackFx: 'SLASH' },
  'enemy-spearman': { familyId: 'cc0-slinger-f1', tint: 0xffffff, displayScale: 1.38, attackFx: 'PIERCE' },
  'enemy-shield': { familyId: 'cc0-bell-crab-f1', tint: 0xffffff, displayScale: 1.44, attackFx: 'BLUNT' },
  'enemy-cultist': { familyId: 'cc0-coffin-merchant-f1', tint: 0xffffff, displayScale: 1.40, attackFx: 'FIRE' },
  'enemy-sniper': { familyId: 'cc0-ink-raven-f1', tint: 0xffffff, displayScale: 1.38, attackFx: 'PIERCE' },
  'enemy-knight': { familyId: 'cc0-glass-keeper-f1', tint: 0xffffff, displayScale: 1.42, attackFx: 'SLASH' },
  'enemy-berserker': { familyId: 'cc0-moss-golem-f1', tint: 0xffffff, displayScale: 1.46, attackFx: 'BLUNT' },
  'enemy-boss': { familyId: 'cc0-paper-dragon-f1', tint: 0xffffff, displayScale: 1.52, attackFx: 'VOID' },
  'enemy-boss-iron': { familyId: 'cc0-meteor-cart-f1', tint: 0xffffff, displayScale: 1.54, attackFx: 'BLUNT' },
  ...
  enemy_ev_sand_crab: { familyId: 'fantasy-warrior', tint: 0xe8c47c, displayScale: 0.82, attackFx: 'SLASH' },
  enemy_ev_foodcart: { familyId: 'hero-knight-2', tint: 0xdb9a68, displayScale: 1.18, attackFx: 'BLUNT' },
  enemy_ev_tailbeast: { familyId: 'fantasy-warrior', tint: 0x73b9d7, displayScale: 1.16, attackFx: 'BLUNT' },
  enemy_ev_firework_jelly: { familyId: 'wizard', tint: 0xff9bc8, displayScale: 1.06, attackFx: 'FIRE' },
  boss_ev_summer_kaiju: { familyId: 'fantasy-warrior', tint: 0x4fa8c6, displayScale: 1.62, attackFx: 'BLUNT' },
  enemy_ev_ze_drone: { familyId: 'huntress', tint: 0x8be2ff, displayScale: 0.84, attackFx: 'PIERCE' },
  enemy_ev_ze_scrap_blade: { familyId: 'warrior', tint: 0xa8b6c7, displayScale: 0.96, attackFx: 'SLASH' },
  enemy_ev_ze_shield: { familyId: 'hero-knight-2', tint: 0x8297a8, displayScale: 1.18, attackFx: 'BLUNT' },
  enemy_ev_ze_railpod: { familyId: 'wizard', tint: 0x6eaed4, displayScale: 1.20, attackFx: 'MAGIC' },
  boss_ev_ze_testframe: { familyId: 'hero-knight', tint: 0x76c6e8, displayScale: 1.58, attackFx: 'PIERCE' },
};

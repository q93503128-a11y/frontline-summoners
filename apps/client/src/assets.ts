...
export const ART_FAMILIES: readonly ArtFamily[] = [
  {
    ...
    idle: { key: 'hero-knight-idle', url: `${VLEE}/HeroKnight/Idle.png`, frameWidth: 180, frameHeight: 180, frames: 11 },
  ...
  },
  {
    ...
    attack: { key: 'wizard-attack', url: `${VLEE}/WizardPack/Attack1.png`, frameWidth: 231, frameHeight: 190, frames: 8 },
  },
  {
...
export const UNIT_ART: Readonly<Record<string, UnitArtVariant>> = {
  ...
  guard: { familyId: 'hero-knight', tint: 0xd9e6ff },
  hunter: { familyId: 'huntress', tint: 0xffffff },
  duelist: { familyId: 'warrior', tint: 0x9fd7ff },
  lancer: { familyId: 'huntress', tint: 0xb8d7ff },
  battlemage: { familyId: 'wizard', tint: 0xffffff },
  pyromancer: { familyId: 'wizard', tint: 0xffa782 },
  royal: { familyId: 'hero-knight', tint: 0xffd86e, displayScale: 1.08 },

...
export const PROFILE_COSMETICS: readonly ProfileCosmeticDefinition[] = [
  ...
  cosmetic('title_pvp_gold', 'TITLE', 'PvP Gold', 'Gold 최초 도달 보상 칭호.'),
  cosmetic('frame_pvp_platinum', 'FRAME', 'PvP Platinum', 'Platinum 최초 도달 보상 테두리.'),
  cosmetic('title_pvp_diamond', 'TITLE', 'PvP Diamond', 'Diamond 최초 도달 보상 칭호.'),
  cosmetic('banner_pvp_master', 'BANNER', 'PvP Master', 'Master 최초 도달 보상 프로필 배너.'),
  cosmetic('emblem_pvp_grandmaster', 'EMBLEM', 'PvP Grandmaster', 'Grandmaster 최초 도달 보상 전용 문장.'),
  cosmetic('frame_pvp_apex', 'FRAME', '전선 최상위', '전선 최상위 최초 도달 보상 테두리.'),
  cosmetic('emblem_pvp_season_gold', 'EMBLEM', '시즌 참가 문장', 'PvP 시즌을 Gold 이상으로 마친 지휘관의 문장.'),
  cosmetic('frame_pvp_season_platinum', 'FRAME', '시즌 전선 프레임', 'PvP 시즌을 Platinum 이상으로 마친 지휘관의 테두리.'),
  cosmetic('title_pvp_season_master', 'TITLE', '시즌 마스터', 'PvP 시즌을 Master 이상으로 마친 지휘관의 칭호.'),
  cosmetic('banner_pvp_season_top1000', 'BANNER', '랭커 천인대', 'PvP 시즌 최종 Top 1000 지휘관의 배너.'),
  cosmetic('emblem_pvp_season_top100', 'EMBLEM', '백인 전선', 'PvP 시즌 최종 Top 100 지휘관의 특수 문장.'),
  cosmetic('badge_pvp_season_top10', 'BADGE', '십인 명예', 'PvP 시즌 최종 Top 10 지휘관의 명예 배지.'),
  ...
  cosmetic('banner_endless_depth', 'BANNER', '심층 전선', '끝없는 전선 15분 생존 고기록을 기념하는 배너.'),
  cosmetic('frame_endless_abyss', 'FRAME', '끝없는 심연', '끝없는 전선 15분 생존 고기록을 기념하는 프레임.'),
  ...
  cosmetic('emblem_bossrush_complete', 'EMBLEM', '보스 러시 제패', '현재 1차 보스 러시 전 구간을 완주한 지휘관의 문장.'),
